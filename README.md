...
```
git clone https://github.com/MihaiHng/foundry-upgrades-f24.git
cd foundry-upgrades-f24
forge build
```
...
You'll want to set your `SEPOLIA_RPC_URL` and `PRIVATE_KEY` as environment variables. You can add them to a `.env` file, which you will have to create.
